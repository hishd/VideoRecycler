package com.hishd.roundcornerimageview;
...
public class RoundCornerImageView extends androidx.appcompat.widget.AppCompatImageView {
    ...
    public RoundCornerImageView(Context context, AttributeSet attrs, int defStyle) {
        ...
        mLeftTopCornerRadius = a.getDimensionPixelSize(
                R.styleable.RoundCornerImageView_sriv_left_top_corner_radius, 0);
        mRightTopCornerRadius = a.getDimensionPixelSize(
                R.styleable.RoundCornerImageView_sriv_right_top_corner_radius, 0);
        mLeftBottomCornerRadius = a.getDimensionPixelSize(
                R.styleable.RoundCornerImageView_sriv_left_bottom_corner_radius, 0);
        mRightBottomCornerRadius = a.getDimensionPixelSize(
                R.styleable.RoundCornerImageView_sriv_right_bottom_corner_radius, 0);
        ...
        mBorderWidth = a.getDimensionPixelSize(
                R.styleable.RoundCornerImageView_sriv_border_width, 0);
        if (mBorderWidth < 0) {
            throw new IllegalArgumentException("border width cannot be negative.");
        }

        mBorderColor = a
                .getColorStateList(R.styleable.RoundCornerImageView_sriv_border_color);
        if (mBorderColor == null) {
            mBorderColor = ColorStateList.valueOf(DEFAULT_BORDER_COLOR);
        }

        isOval = a.getBoolean(R.styleable.RoundCornerImageView_sriv_oval, false);
        a.recycle();
    ...
    public void setImageDrawable(Drawable drawable) {
        mResource = 0;
        mDrawable = SelectableRoundedImageViewDrawable.fromDrawable(drawable, getResources());
    ...
    public void setImageBitmap(Bitmap bm) {
        mResource = 0;
        mDrawable = SelectableRoundedImageViewDrawable.fromBitmap(bm, getResources());
        super.setImageDrawable(mDrawable);
        updateDrawable();
    }
    ...
    private Drawable resolveResource() {
        ...
        return SelectableRoundedImageViewDrawable.fromDrawable(d, getResources());
    }
    ...
    private void updateDrawable() {
        ...
        ((SelectableRoundedImageViewDrawable) mDrawable).setScaleType(mScaleType);
        ((SelectableRoundedImageViewDrawable) mDrawable).setCornerRadii(mRadii);
        ((SelectableRoundedImageViewDrawable) mDrawable).setBorderWidth(mBorderWidth);
        ((SelectableRoundedImageViewDrawable) mDrawable).setBorderColor(mBorderColor);
        ((SelectableRoundedImageViewDrawable) mDrawable).setOval(isOval);
    }
    ...
    static class SelectableRoundedImageViewDrawable extends Drawable {

        private static final String TAG = "SelectableRImageView";
        private static final int DEFAULT_BORDER_COLOR = Color.BLACK;
        ...
        public SelectableRoundedImageViewDrawable(Bitmap bitmap, Resources r) {
            mBitmap = bitmap;
        ...
        public static SelectableRoundedImageViewDrawable fromBitmap(Bitmap bitmap, Resources r) {
            if (bitmap != null) {
                return new SelectableRoundedImageViewDrawable(bitmap, r);
            } else {
                return null;
            }
        }
        ...
        public static Drawable fromDrawable(Drawable drawable, Resources r) {
            if (drawable != null) {
                if (drawable instanceof SelectableRoundedImageViewDrawable) {
                    return drawable;
                ...
                if (bm != null) {
                    return new SelectableRoundedImageViewDrawable(bm, r);
                } else {
